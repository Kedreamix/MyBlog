...
[PDF](http://arxiv.org/abs/2312.09093v3) AAAI 2024, code available at   https://cuiziteng.github.io/Aleth_NeRF_web/ Modified version of previous   paper arXiv:2303.05807
...
* 3D 视图细化：这一步重点是细化从粗糙 NeRF 渲染的 3D 感知图像，然后重建一个增强的优质 NeRF。假设我们渲染与视图无关的帧，即 ˆIvi，则使用与视图无关的分量对其进行细化，如下所示：ˆIvi=G3(ˆIvi,P0,Iseed)。然后，我们使用细化的图像来更新 NeRF，如下所示：ˆσ=ˆσ+αˆσ，ˆb=ˆb+αˆb，其中 α 是学习率。我们重复此过程，直到达到收敛。</p>
<ol>
<li>结论：
